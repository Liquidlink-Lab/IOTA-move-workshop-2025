...
module example2::objectexample2;
...
fun random_val(r:&Random,low:u64,high:u64,ctx:&mut TxContext):u64{
...
public entry fun get_a_watch(r:&Random,ctx: &mut TxContext) {
    let random_val = random_val(r,5,10,ctx);
    let new_watch = Watch {
        id: object::new(ctx),
        value: random_val,
    };
